...
namespace disk.Services.Logging
{
    ...
    public class MemberActivityService : IMemberActivityService
    {
        ...
        public MemberActivityService(ICacheManager cacheManager,
        ...
        {
            return InsertActivity(systemKeyword, comment, _workContext.CurrentMember, commentParams);
        }
        ...
        /// <returns>Activity log item</returns>
        public virtual ActivityLog InsertActivity(string systemKeyword, 
            string comment, Member Member, params object[] commentParams)
        {
            if (Member == null)
                return null;
        ...
        /// </summary>
        /// <param name="createdOnFrom">Log item creation from; null to load all Members</param>
        /// <param name="createdOnTo">Log item creation to; null to load all Members</param>
        /// <param name="MemberId">Member identifier; null to load all Members</param>
        /// <param name="activityLogTypeId">Activity log type identifier</param>
       ...
       /* public virtual IPagedList<ActivityLog> GetAllActivities(DateTime? createdOnFrom,
            DateTime? createdOnTo, int? MemberId, int activityLogTypeId,
            int pageIndex, int pageSize)
        {
            ...
            if (MemberId.HasValue)
                query = query.Where(al => MemberId.Value == al.MemberId);
