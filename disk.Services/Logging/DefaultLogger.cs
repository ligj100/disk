...
namespace disk.Services.Logging
{
    ...
    public partial class DefaultLogger : ILogger
    {
        ...
        */
        ...
        /// <param name="Member">The Member to associate log record with</param>
        /// <returns>A log item</returns>
        public virtual Log InsertLog(LogLevel logLevel, string shortMessage, string fullMessage = "", Member Member = null)
        {
            var log = new Log()
            {
                LogLevel = logLevel,
