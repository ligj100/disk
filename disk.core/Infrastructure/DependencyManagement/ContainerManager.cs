...
namespace disk.Core.Infrastructure.DependencyManagement
{
    public class ContainerManager
    {
        ...
        public object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new DiskException("Unkown dependency");
            ...
            throw new DiskException("No contructor was found that had all the dependencies satisfied.");
        }
