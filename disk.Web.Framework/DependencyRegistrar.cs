         ...
         /*   //user agent helper
            ...
            */
            ...
            if (dataProviderSettings != null && dataProviderSettings.IsValid())
            {
                ...
                builder.Register<IDbContext>(c => new DiskObjectContext(dataProviderSettings.DataConnectionString)).InstancePerLifetimeScope();
            }
            else
            {
                builder.Register<IDbContext>(c => new DiskObjectContext(dataSettingsManager.LoadSettings().DataConnectionString)).InstancePerLifetimeScope();
            }
