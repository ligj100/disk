...
namespace disk.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        private Member _originalMemberIfImpersonated;
        ...
        public virtual Member CurrentMember
        {
            ...
            get
            {
                ...
                if (_httpContext == null || _httpContext is FakeHttpContext)
                {
                    ...
                    member = _memberService.GetCustomerBySystemName(SystemCustomerNames.BackgroundTask);
                }

                //check whether request is made by a search engine
                //in this case return built-in customer record for search engines 
                //or comment the following two lines of code in order to disable this functionality
                if (member == null || member.Deleted || !member.Active)
                {
            ...
            set
            {
                SetCustomerCookie(value.MemberGuid);
                _cachedMember = value;
            }
        ...
        /// </summary>
        public virtual Member OriginalMemberIfImpersonated
        {
            get
            {
                return _originalMemberIfImpersonated;
            }
        }
