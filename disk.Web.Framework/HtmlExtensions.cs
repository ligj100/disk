...
namespace disk.Web.Framework
{
    public static class HtmlExtensions
    {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string buttonsSelector) where T : BaseDiskEntityModel
        {
        ...
        public static MvcHtmlString DeleteConfirmation<T>(this HtmlHelper<T> helper, string actionName,
            string buttonsSelector) where T : BaseDiskEntityModel
        {
            ...
            window.AppendLine(string.Format("title: '{0}',", "你确认了嘛？"));
            ...
            int? selectedDay = null, int? selectedMonth = null, int? selectedYear = null, bool localizeLabels = true)
        {
            ...
            if (localizeLabels)
            {
                ...
                dayLocale = "日"; //locService.GetResource("Common.Day");
                monthLocale = "月";//locService.GetResource("Common.Month");
                yearLocale = "年"; // locService.GetResource("Common.Year");
            }
            else
            {
                dayLocale = "Day";
